                            ...
                            <div class="col-lg-3">
                                <div class="row g-4">
                                                    ...
                                                    <ul class="list-unstyled fruite-categorie">
                                                        <li>
                                                            <div class="d-flex justify-content-between fruite-name">
                                                                <a href="shop_old.php?cat_id=<?php echo $row['category_id'] ?>"><i
                                    ...
                                    <?php if (!isset($_GET['a_id'])) {
                                                        ...
                                                        <div class="rounded position-relative fruite-item">
                                                            <form method="post" action="controller/add_cart.php">
                                                                <!-- <input type="hidden" name="c_id"
                                                                    value="<?php echo $_SESSION['a_id']; ?>"> -->
                                                                <input type="hidden" name="g_id"
                                                                    value="<?php echo $row['grocery_id']; ?>">
                                        ...
                                        $id = $_SESSION['a_id'];
                                        $stmt = $admin->ret("SELECT * FROM `category` INNER JOIN `manage_grocery` ON category.category_id=manage_grocery.category_id WHERE category.category_id=$id");
                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                                    <div class="col-lg-9">
                                                        <div class="row g-4 justify-content-center">
