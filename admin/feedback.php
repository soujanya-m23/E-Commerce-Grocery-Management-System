          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table">
                <tbody>
                  <?php
                  $stmt = $admin->ret("SELECT * FROM `feedback` INNER JOIN `customer` ON feedback.customer_id=customer.customer_id INNER JOIN `manage_grocery`ON  manage_grocery.grocery_id=feedback.grocery_id");
