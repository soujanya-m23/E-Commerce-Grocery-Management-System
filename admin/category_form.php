        ...
        <div class="d-flex justify-content-center align-items-center">
          <div class="card">
            <div class="card-body" style="width:500px;">
              ...
              <form action="controller/add_category.php" method="POST" enctype="multipart/form-data">
                <label for="category">Category Name:</label>
                <input type="text" class=" form-control form-control-rounded" name="category" required>

                <div class="form-group">
                  <label for="input-8">Status</label>
